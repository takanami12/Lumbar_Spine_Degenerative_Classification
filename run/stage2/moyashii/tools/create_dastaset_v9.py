...
DST_DIR = SETTINGS.train_data_clean_dir / f'{args.user}/classification_datasets/v9'
DST_DIR.mkdir(exist_ok=True, parents=True)

SAGITTAL_CROP_MM = [35, 50]  # h:35mm, w:50mm
SAGITTAL_CROP_OFFSET_MM = [-5, 0]  # h:-5mm, w:0mm
AXIAL_CROP_MM = [45, 75]  # h:45mm, w:75mm
AXIAL_CROP_OFFSET_MM = [5, 0]  # h:5mm, w:0mm
...
# %%
COORD_DF = pd.read_csv(SETTINGS.train_data_clean_dir / f'{args.user}/keypoint_datasets/v2/train_label_coordinates_fixed.csv')
COORD_DF.head()
